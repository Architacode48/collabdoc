$(function () {
    ...
    function syncDrawingData(data) {
        ...
        if(data.textarea_color=='white'){document.getElementById('text_area').style.backgroundColor='white'}
        if(data.textarea_color=='red'){document.getElementById('text_area').style.backgroundColor='red'}
        if(data.textarea_color=='green'){document.getElementById('text_area').style.backgroundColor='green'}
        if(data.textarea_color=='yellow'){document.getElementById('text_area').style.backgroundColor='yellow'}
    }
    ...
    function messageSync()
{
    ...
    function select_color(){
        selectedcolor=document.getElementById('select').value
        if(selectedcolor=='white'){
            background_color='white'
        }
        if(selectedcolor=='red'){background_color='red'}
        if(selectedcolor=='green'){background_color='green'}
        if(selectedcolor=='yellow'){background_color='yellow'}
